...
# get the season by season data for each player in the comp group
# season by season data is how we will project the progress of our current player
def getCompPlayerSeasonData(compDict):
    playerList = []
    for key in compDict:
        playerList.append(compDict.get(key)[1])

    testPlayer = playerList[0]
    print(testPlayer)
...
def main():
    ...
    getCompPlayerSeasonData(compDict)
